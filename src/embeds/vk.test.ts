...
describe('vkResolveEmbed', () => {
  describe('happy paths', () => {
    ...
    it('should keep the hash that unlocks a private video and drop the rest', () => {
      ...
      const expected: EmbedResolverResult = {
        ...
        url: 'https://vkvideo.ru/video123_456',
      }

      expect(vkResolveEmbed(value)).toEqual(expected)
    })

    it('should read the player on the vk.ru host', () => {
      const value = 'https://vk.ru/video_ext.php?oid=-214899652&id=456246970'
      const expected: EmbedResolverResult = {
        provider: 'vk',
        id: '-214899652_456246970',
  ...
  describe('sad paths', () => {
    ...
    it('should ignore a video id outside its alphabet', () => {
      const value = 'https://vk.com/video_ext.php?oid=-1&id=../x'
