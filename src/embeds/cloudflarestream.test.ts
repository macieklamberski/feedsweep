...
describeForEachParser('cloudflarestream through the pipeline', (parseHtml) => {
  ...
  it('should leave a download enclosure on the account host playable', async () => {
    const enclosures = [
      {
        url: 'https://customer-k3f9x2mq7t1bv8dw.cloudflarestream.com/9c2e41a7b3d5486fa0c17e93d2b6f05a/downloads/default.mp4',
        type: 'video/mp4',
      },
    ]

    const expected = html`
      <video data-enclosure="" controls src="https://customer-k3f9x2mq7t1bv8dw.cloudflarestream.com/9c2e41a7b3d5486fa0c17e93d2b6f05a/downloads/default.mp4"></video>
      <p>Body</p>
    `
  ...
  it('should leave a download enclosure on the delivery host playable', async () => {
    const enclosures = [
      {
        url: 'https://iframe.videodelivery.net/4f7b0c8e15d94a63b28e7fa0d6c13e59/downloads/default.mp4',
        type: 'video/mp4',
      },
    ]

    const expected = html`
      <video data-enclosure="" controls src="https://iframe.videodelivery.net/4f7b0c8e15d94a63b28e7fa0d6c13e59/downloads/default.mp4"></video>
      <p>Body</p>
    `
