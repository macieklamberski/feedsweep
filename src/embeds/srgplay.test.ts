...
describeForEachParser('srgplayEmbedResolver', (parseHtml) => {
  ...
  describe('sad paths', () => {
    ...
    // separator would choose the query. The shared host names no business unit, so a retired
    // player answering there has nothing to compose the urn from.
    it.each([
  ...
  describe('edge cases', () => {
    ...
    it('should not resolve the swi unit, whose player redirects to an article', async () => {
      const value =
