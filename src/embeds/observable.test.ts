...
describeForEachParser('observableEmbedResolver', (parseHtml) => {
  ...
  describe('the unlisted notebook route', () => {
    ...
    it('should leave the id-addressed embed url to the generic placeholder', async () => {
      const value =
        '<iframe src="https://observablehq.com/embed/1234567890abcdef@406?cells=map"></iframe>'
