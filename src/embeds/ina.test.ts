...
describeForEachParser('inaEmbedResolver', (parseHtml) => {
  ...
  describe('happy paths', () => {
    ...
    it('should keep the carrier url where no player id and key are named', async () => {
      const value = html`<iframe src="https://player.ina.fr/player/embed/I04224962"></iframe>`
      const expected: EmbedResolverResult = {
        provider: 'ina',
        id: 'I04224962',
        src: 'https://player.ina.fr/player/embed/I04224962',
        url: 'https://www.ina.fr/video/I04224962',
      }
